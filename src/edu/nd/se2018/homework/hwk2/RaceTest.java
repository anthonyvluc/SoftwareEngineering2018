...
public class RaceTest {
	...
	@Test
	public void test() {
//		Here are some ideas for testing your race. You should create your own test cases though -- this assumes that you have a race class and a method called enrollHorse which accepts a horse name (String), a horse number (int), initial speed (int), and a strategy.  You don't need to have these classes -- you could have a different design and modify the tests accordingly.
//
//		// Test ideas #1
